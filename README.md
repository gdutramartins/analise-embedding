...
## Execução
Como nosso objetivo é comparar modelos, então os passos executados são similares, ajustando somente a chamada ao modelo para fazer o embedding do documento e da pergunta. O Amazon Titan teve um tratamento diferente porque sua invocação é por serviço, mas os detalhes serão trataos em um subtópico.   
